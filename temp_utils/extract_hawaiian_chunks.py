...
def process_pdf(pdf_path, output_dir=None, max_words=400):
    ...
    if not chapters:
        print("❌ No chapters found in PDF table of contents.")
        return
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 extract_hawaiian_chunks.py <pdf_path> [output_dir] [max_words]")
        print("\nExample:")
        print("  python3 extract_hawaiian_chunks.py Data/raw/HawaiianPlantLife.pdf")
        print("  python3 extract_hawaiian_chunks.py Data/raw/DSM5.pdf Data/dsm5_chunks 400")
        sys.exit(1)
